  ...
  return (
    <IconContainer>
      <svg width="22" height="17" viewBox="0 0 22 17" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path fill-rule="evenodd" clip-rule="evenodd" d="M0.105792 10.553C0.352781 10.059 0.953454 9.8588 1.44743 10.1058L11.0002 14.8822L20.553 10.1058C21.047 9.8588 21.6477 10.059 21.8946 10.553C22.1416 11.047 21.9414 11.6477 21.4474 11.8946L11.4474 16.8946C11.1659 17.0354 10.8345 17.0354 10.553 16.8946L0.553005 11.8946C0.059027 11.6477 -0.141197 11.047 0.105792 10.553Z" fill="#CAD6D1"/>
