...
interface IThreeDotsIconMobile {
...
const ThreeDotsIconMobile: React.FC<IThreeDotsIconMobile> = ({ setState }) => {
  return (
    <IconContainer onClick={() => setState(true)} >
...
export default ThreeDotsIconMobile;
